...
--
-- Host: localhost
-- Waktu pembuatan: 16. Oktober 2013 jam 17:02
-- Versi Server: 5.1.41
-- Versi PHP: 5.3.1
...
(1, 'Home', 'home', 1, 1, 'en'),
(2, 'Contact Us', 'contact', 2, 1, 'en'),
(3, 'Retail Location', 'location', 3, 1, 'en'),
(4, 'About Us', 'about', 4, 1, 'en'),
(5, 'Careers', 'career', 5, 1, 'en'),
(6, 'Privacy & Security Policy', 'privacy', 6, 1, 'en');
...
(1, 'Home', 'home', 1, 1, 'en', 0),
(2, 'Product', 'product', 2, 1, 'en', 0),
(3, 'About Us', 'about', 3, 1, 'en', 0),
(4, 'Contact Us', 'contact', 4, 1, 'en', 0),
(5, 'Retail Location', 'location', 5, 1, 'en', 0);
