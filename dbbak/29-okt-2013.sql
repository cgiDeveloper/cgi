...
--
-- Host: localhost
-- Waktu pembuatan: 29. Oktober 2013 jam 16:13
-- Versi Server: 5.1.41
-- Versi PHP: 5.3.1
...
(8, 1, 'en', NULL, 'product', 'Product', '2013-10-29 09:13:27', 'product-image.jpg'),
(9, 1, 'id', NULL, 'product', 'Produk', '2013-10-29 09:14:10', 'product-image.jpg');
...
INSERT INTO `product` (`id`, `product_name`, `product_description`, `id_category`, `img_product`, `motif`, `price_rtt`, `price`, `stock`, `updated_time`, `order`, `status`) VALUES
(1, 'Millenia Premium A', '', 1, 'cth-blanket.jpg', 'Red', 150000, 100000, 100, '2013-10-29 13:25:59', 1, 1),
(2, 'Olivia Junior', '', 1, '', '', 0, 0, 0, '2013-10-29 15:20:26', 2, 1),
(3, 'Viola', '', 1, '', '', 0, 0, 0, '2013-10-29 15:20:48', 3, 1),
(4, 'Millenia Premium B', '', 1, '', '', 0, 0, 0, '2013-10-29 15:21:41', 4, 1),
(5, 'Millenia Platinum', '', 1, '', '', 0, 0, 0, '2013-10-29 15:22:00', 5, 1);
...
CREATE TABLE IF NOT EXISTS `product_category` (
  ...
  `img_category_big` varchar(50) DEFAULT NULL,
  `order` int(11) NOT NULL,
  `status` int(11) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `product_category` (`id`, `category_name_en`, `category_name_id`, `img_category`, `img_category_big`, `order`, `status`) VALUES
(1, 'Blanket', 'Selimut', 'blanket.jpg', 'blanket-big.jpg', 0, 1),
(2, 'Bedsheet', 'Sprei', 'bedsheet.jpg', NULL, 0, 1),
(3, 'Pillow', 'Bantal', 'pillow.jpg', NULL, 0, 1),
(4, 'CVC', 'Bahan CVC', 'cvc.jpg', NULL, 0, 1);
